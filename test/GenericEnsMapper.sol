...
using stdStorage for StdStorage;
    ...
    function setupMockEnsToken(uint256[] memory _id, address[] memory _owner) private {
   ...
   function testConfigureEnsForSingleNftContractNotIERC721_fail() public {
    ...
    function testConfigureEnsAlreadyConfiguredAddNftContractNotApprovedEnsOwner_fail() public {
            //assign
        uint256 ensId;
        bytes32 ensHash = bytes32(ensId);
        bool numericOnly = false;
    ...
    function testConfigureEnsAlreadyConfiguredAddDuplicateNftContract_fail() public {
        //assign
        uint256 ensId;
        bytes32 ensHash = bytes32(ensId);
        bool numericOnly = false;
    ...
    function testConfigureEnsForSingleNftChangeNumericOnlyTrueMultipleNftContracts_fail() public {
        ...
        mapper.updateSettingsToExistingEns(ensHash, !numericOnly, overwriteUnusedSubdomains);
    ...
    function testConfigureEnsAlreadyConfiguredEnsChangeOverwriteSubdomains_pass() public {
       //assign
        ...
        //assert
        assertTrue(overwriteUnusedSubdomainsValue, "numericOnly should be true");
    ...
    function testClaimSubdomainWithEligibleNft_pass() public {
        ...
        (IERC721 nftValue, uint256 idValue) = mapper.SubnodeToNftDetails(subnodeHash);
    ...
    function testClaimSubdomainWithTwoEligibleNft_pass() public {
       //assign
        ...
        (IERC721 nftValue, uint256 idValue) = mapper.SubnodeToNftDetails(subnodeHash);
        (IERC721 nftValue2, uint256 idValue2) = mapper.SubnodeToNftDetails(subnodeHash2);
        vm.stopPrank();
    ...
    function testRemoveSubdomainFromNotApprovedAddress_fail() public {
        ...
        (IERC721 nftValue2, uint256 idValue2) = mapper.SubnodeToNftDetails(subnodeHash);
    ...
    function testClaimSubdomainFromMultipleNftEnsContract_pass() public {
        ...
        (IERC721 nftValue1, uint256 idValue1) = mapper.SubnodeToNftDetails(subnodeHash1);
        (IERC721 nftValue2, uint256 idValue2) = mapper.SubnodeToNftDetails(subnodeHash2);
        (IERC721 nftValue3, uint256 idValue3) = mapper.SubnodeToNftDetails(subnodeHash3);

        assertEq(address(nftValue1), address(nftArray[0]), "NFT address incorrect");
        assertEq(idValue1, 1, "NFT token id incorrect"); 
        assertEq(nftValue1.ownerOf(1), address(0xaa998877), "NFT ownerOf incorrect");


        assertEq(address(nftValue2), address(nftArray[1]), "NFT address incorrect");
        assertEq(idValue2, 2, "NFT token id incorrect"); 
        assertEq(nftValue2.ownerOf(2), address(0xaa998877), "NFT ownerOf incorrect");

        assertEq(address(nftValue3), address(nftArray[2]), "NFT address incorrect");
        assertEq(idValue3, 3, "NFT token id incorrect"); 
        assertEq(nftValue3.ownerOf(3), address(0xaa998877), "NFT ownerOf incorrect");
    ...
    function testClaimSubdomainFromIncorrectButExistingNft_fail() public {
       //assign
        ...
        mapper.addEnsContractMapping(ensHash, nftArray, numericOnly, overwriteUnusedSubdomains);
        nftArray[0] = new Mock721();
        mapper.addEnsContractMapping(ensHash2, nftArray, numericOnly, overwriteUnusedSubdomains);
    ...
    function testRemoveSubdomainApplySameSubdomainWhenAllowed_pass() public {
        ...
        (IERC721 nftValue, uint256 idValue) = mapper.SubnodeToNftDetails(subdomainHash);
   ...
   function testEmitAddrChangedOnRemoval_pass() public {
    ...
    function testNamehashFunctionMainDomain() public {
        ...
        assertEq(mapper.getDomainHash(domain), pccEth, "domain namehash incorrect");
    }
    ...
    function testNamehashFunctionSubdomain() public {
        ...
        assertEq(mapper.getDomainHash(domainArray), hodlPccEth, "subdomain namehash incorrect");
